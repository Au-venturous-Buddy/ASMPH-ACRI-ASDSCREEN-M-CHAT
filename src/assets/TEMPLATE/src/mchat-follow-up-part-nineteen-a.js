...
import MCHATFollowUpPartNineteenB from "./mchat-follow-up-part-nineteen-b";
...
export default function MCHATFollowUpPartNineteenA(props) {
  ...
  return(
    <Questionnaire partID="19-0" questionFields={questionFields} getResult={getResult} currentLanguage={props.state.currentLanguage} stateMain={props.stateMain} data={props.data} restartTestMain={props.restartTestMain} />
  )
}