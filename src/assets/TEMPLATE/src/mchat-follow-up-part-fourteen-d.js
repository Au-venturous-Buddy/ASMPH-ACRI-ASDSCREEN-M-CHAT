...
export default function MCHATFollowUpPartFourteenD(props) {
  ...
  return(
    <Questionnaire partID="14-3" questionFields={questionFields} getResult={getResult} currentLanguage={props.state.currentLanguage} stateMain={props.stateMain} data={props.data} restartTestMain={props.restartTestMain} />
  )
}