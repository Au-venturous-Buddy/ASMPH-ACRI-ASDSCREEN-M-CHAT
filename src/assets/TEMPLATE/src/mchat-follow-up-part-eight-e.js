...
export default function MCHATFollowUpPartEightE(props) {
  ...
  return(
    <Questionnaire partID="08-4" questionFields={questionFields} getResult={getResult} currentLanguage={props.state.currentLanguage} stateMain={props.stateMain} data={props.data} restartTestMain={props.restartTestMain} />
  )
}