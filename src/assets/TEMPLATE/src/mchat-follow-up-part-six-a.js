...
import MCHATFollowUpPartSixB from "./mchat-follow-up-part-six-b";
...
export default function MCHATFollowUpPartSixA(props) {
  ...
  return(
    <Questionnaire partID="06-0" questionFields={questionFields} getResult={getResult} currentLanguage={props.state.currentLanguage} stateMain={props.stateMain} data={props.data} restartTestMain={props.restartTestMain} />
  )
}