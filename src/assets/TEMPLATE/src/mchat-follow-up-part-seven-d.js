...
export default function MCHATFollowUpPartSevenD(props) {
  ...
  return(
    <Questionnaire partID="07-3" questionFields={questionFields} getResult={getResult} currentLanguage={props.state.currentLanguage} stateMain={props.stateMain} data={props.data} restartTestMain={props.restartTestMain} />
  )
}