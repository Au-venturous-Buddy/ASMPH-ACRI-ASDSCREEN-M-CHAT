...
export default function MCHATFollowUpPartEighteenC(props) {
  ...
  return(
    <Questionnaire partID="18-2" questionFields={questionFields} getResult={getResult} currentLanguage={props.state.currentLanguage} stateMain={props.stateMain} data={props.data} restartTestMain={props.restartTestMain} />
  )
}