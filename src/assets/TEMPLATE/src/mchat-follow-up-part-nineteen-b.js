...
import MCHATFollowUpPartNineteenC from "./mchat-follow-up-part-nineteen-c";
...
export default function MCHATFollowUpPartNineteenB(props) {
  ...
  return(
    <Questionnaire partID="19-1" questionFields={questionFields} getResult={getResult} currentLanguage={props.state.currentLanguage} stateMain={props.stateMain} data={props.data} restartTestMain={props.restartTestMain} />
  )
}